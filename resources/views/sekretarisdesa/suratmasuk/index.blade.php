...
<style>
    ...
    .badge-admin {background:#eff6ff;color:#1d4ed8;border:1px solid #bfdbfe;font-weight:600;padding:5px 12px;border-radius:20px;font-size:.78rem}
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-footer bg-white py-3 px-4">
                ...
                <button type="button" class="btn btn-danger btn-rounded px-4" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#modalTolakSekdes-{{ $r->id_pengajuan }}">Tolak</button>
                <form action="{{ route('sekdes.suratmasuk.setuju', $r->id_pengajuan) }}" method="POST" style="display:inline;">
                    @csrf
                    <button type="submit" class="btn btn-success btn-rounded px-4">Setujui & Teruskan</button>
                </form>
            </div>
        </div>
    </div>
