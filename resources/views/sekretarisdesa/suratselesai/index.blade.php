...
<section class="section">
    <div class="section-header d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="fw-bold text-dark mb-1">Arsip Surat Selesai — Sekretaris Desa</h1>
            <p class="text-muted small mb-0">Daftar seluruh surat yang telah diverifikasi dan diselesaikan.</p>
        </div>
    </div>
    ...
    <div class="section-body">
        <div class="card card-modern">
            <div class="card-header bg-white py-3 border-bottom-0 d-flex justify-content-between align-items-center">
                <h4 class="fw-bold text-dark m-0"><i class="bi bi-file-earmark-check-fill text-success me-2"></i>Data Pengajuan Surat Selesai</h4>
                <form class="d-flex" action="{{ route('sekdes.suratselesai.index') }}" method="get">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-modern w-100" id="tableSuratSelesaiSekdes">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="7" class="text-center py-4 text-muted">Belum ada data surat selesai.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
