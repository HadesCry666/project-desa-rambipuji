                    ...
                    <table class="table table-modern w-100" id="tableKadus">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="badge bg-light text-dark border fw-medium">{{ $r->nama_surat ?? 'Surat Keterangan' }}</span></td>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-sm btn-info btn-rounded px-2 me-1" data-bs-toggle="modal" data-bs-target="#modalDetail-{{ $r->id_pengajuan }}"><i class="bi bi-eye-fill"></i> Detail</button>
                                    ...
                                    <button class="btn btn-sm btn-danger btn-rounded px-2" data-bs-toggle="modal" data-bs-target="#modalTolak-{{ $r->id_pengajuan }}"><i class="bi bi-x-lg"></i> Tolak</button>
                                </td>
                            </tr>
                            @empty
                            <tr>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                ...
                <div class="card border-0 shadow-sm rounded-3 p-3">
                    ...
                    <div class="position-relative" style="padding-left:28px;border-left:2px solid #e2e8f0">
                        <div class="mb-3 position-relative">
                            ...
                            <small class="text-muted">{{ $r->tanggal_diajukan ?? $r->created_at }} — Pengajuan masuk</small>
                        </div>
            ...
            <div class="modal-footer bg-white py-3 px-4">
                ...
                <button type="button" class="btn btn-danger btn-rounded px-4" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#modalTolak-{{ $r->id_pengajuan }}"><i class="bi bi-x-circle-fill me-1"></i>Tolak</button>
                <form action="{{ route('kadus.suratmasuk.setuju', $r->id_pengajuan) }}" method="POST" style="display:inline;">
                    @csrf
