            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <form id="searchForm"
                              class="d-flex"
                              action="{{ route('rt.suratmasuk.index') }}"
                              method="get">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex justify-content-end gap-2">
                ...
                <button type="button"
                        ...
                        data-bs-toggle="modal"
                        data-bs-target="#modalTolak-{{ $a->id_pengajuan }}">
                ...
                <form method="POST"
                      action="{{ route('rt.suratmasuk.setuju', $a->id_pengajuan) }}">
...
<div class="modal fade"
    ...
    <div class="modal-dialog">
        ...
        <form method="POST"
              action="{{ route('rt.suratmasuk.tolak', $a->id_pengajuan) }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <label for="keterangan_ditolak_{{ $a->id_pengajuan }}"
                               class="form-label">
                        ...
                        <textarea name="keterangan_ditolak"
                                  id="keterangan_ditolak_{{ $a->id_pengajuan }}"
                                  class="form-control"
                                  rows="3"
                                  required></textarea>
