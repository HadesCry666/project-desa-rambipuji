                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        <form id="searchForm" class="d-flex"
                            action="{{ route('rw.suratmasuk.index') }}"
                            method="get">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <button type="button"
                                                ...
                                                data-bs-target="#modalDetail-{{ $item->id_pengajuan }}">
...
<div class="modal fade"
     id="modalDetail-{{ $item->id_pengajuan }}"
     tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="text"
                       class="form-control"
                       value="{{ $item->tempat_tanggal_lahir }}"
                       readonly>

                <label class="form-label mt-2">Warga / Agama</label>
                <input type="text"
                       class="form-control"
                       value="{{ $item->warga_agama }}"
                       readonly>
            ...
            <div class="modal-footer d-flex justify-content-end">
                <form method="POST"
                      action="{{ route('rw.suratmasuk.setujui', $item->id_pengajuan) }}">
