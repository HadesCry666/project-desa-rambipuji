...
@section('title', 'Surat Selesai (TTE) Kepala Desa')
...
<section class="section">
    <div class="section-header d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="fw-bold text-dark mb-1">Arsip Surat Selesai TTE — Kepala Desa</h1>
            <p class="text-muted small mb-0">Arsip dokumen surat resmi desa yang telah ditandatangani secara elektronik (TTE).</p>
        </div>
        <div>
            <span class="badge bg-success rounded-pill px-3 py-2">
                <i class="bi bi-patch-check-fill me-1"></i> Terverifikasi TTE
            </span>
        </div>
    </div>
        ...
        <div class="card card-modern">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-modern w-100" id="tableSuratSelesaiKades">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="7" class="text-center py-4 text-muted">Belum ada surat yang disahkan (TTE).</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
