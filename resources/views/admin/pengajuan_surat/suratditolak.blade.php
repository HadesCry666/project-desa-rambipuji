                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            {{-- DETAIL --}}
                                            <button class="btn btn-sm btn-info btn-rounded me-1"
                                                data-toggle="modal"
                                                data-target="#modalDetailAdmin-{{ $a->id_pengajuan }}">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                ...
                {{-- KETERANGAN DITOLAK --}}
                @if(!empty($a->keterangan_ditolak))
                    <div class="card border-0 shadow-sm rounded-3 p-3 mb-3">
                        <h6 class="fw-bold border-bottom pb-2 mb-3">
                            Keterangan Ditolak
                        </h6>

                        <div class="alert alert-danger mb-0 py-3 px-4"
                            style="border-radius: 18px;">
                            <div class="d-flex align-items-center">
                                <i class="bi bi-exclamation-triangle-fill fs-5 flex-shrink-0" style="margin-right: 7px;"></i>
                                <span class="fw-medium">
                                    {{ $a->keterangan_ditolak }}
                                </span>
                            </div>
                        </div>
                    </div>
