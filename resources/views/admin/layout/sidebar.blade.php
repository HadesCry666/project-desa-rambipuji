  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      @if($isSekdes)
        ...
        <li class="{{ Request::is('sekretarisdesa/penduduk*') ? 'active' : '' }}">
          <a class="nav-link" href="{{ url('/sekretarisdesa/penduduk') }}"><i class="fas fa-users"></i><span>Data Penduduk</span></a>
        </li>
      ...
      @elseif($isKades)
        ...
        <li class="{{ Request::is('kepaladesa/penduduk*') ? 'active' : '' }}">
          <a class="nav-link" href="{{ url('/kepaladesa/penduduk') }}"><i class="fas fa-users"></i><span>Data Penduduk</span></a>
        </li>
