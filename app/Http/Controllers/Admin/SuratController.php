...
class SuratController extends Controller
{
    public function index(Request $request)
    {
        ...
        if (strlen($katakunci)) {
            ...
            $datasurat = master_surat::orderBy(
                    'id_surat',
                    'asc'
                )
                ->paginate($jumlahbaris);
    ...
    public function store(Request $request)
    {
        ...
        master_surat::create([
            ...
            'berkas4' => $request->berkas4,
            'berkas5' => $request->berkas5,
            'berkas6' => $request->berkas6,
            'berkas7' => $request->berkas7,
            'berkas8' => $request->berkas8,

        ]);

        return redirect()
            ->route('mastersurat.index')
            ->with(
                'success',
